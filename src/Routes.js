...
import House from "./components/Inhouse";
import House_edit from "./components/Inhouse_edit";
import House2 from "./components/Promise";
import Input from "./components/InputArr";
import CatInput from "./components/CatInputs";
import View from "./components/ViewBranch";
  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path="/inhouse" component={House} />
        <Route exact path="/inhouse_edit/:brno" component={House_edit} />
        <Route exact path="/promise/:brno" component={House2} />
        ...
        <Route path="/catinput" component={CatInput} />
        {/* FREE */}
